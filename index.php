                        ...
                        <ul class="navbar-nav ms-lg-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                    <li><a class="dropdown-item" href="tournaments.php">Event Listing</a></li>

                                    <li><a class="dropdown-item" href="tournaments.php">Tournament Detail</a></li>
                                </ul>
                            </li>
                        </ul>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <?php if ($databaseError): ?>
                            <div class="col-12">
                                <p>Databaza momentalne nie je dostupna. Zapnite MySQL v XAMPP a turnaje sa nacitaju automaticky.</p>
                            </div>
                        <?php elseif ($tournaments === []): ?>
                            <div class="col-12">
                                <p>Zatial nie su vypisane ziadne turnaje.</p>
                            </div>
                        <?php else: ?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-12">
                        ...
                        <br>
                        <p class="copyright-text">Copyright Ä‚â€šĂ‚Â© 2048 Tiya Golf Club</p>
                    </div>
